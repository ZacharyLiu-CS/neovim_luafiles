...
-- Move text up and down
-- Here are three option mode
-- x: activated only in visual mode
-- s: activated only in select mode
-- v: activate in both two modes
keymap("v", "<A-j>", ":move '>+1<CR>gv-gv", opts)
keymap("v", "<A-k>", ":move '<-2<CR>gv-gv", opts)

-- Paste the content without polluting the register
keymap("v", "p", '"_dP', opts)
