local options = {
  ...
  colorcolumn = '100',                       -- highlight the column separator
  number = true,                           -- set numbered lines
  relativenumber = true,                   -- set relative numbered lines
  numberwidth = 4,                         -- set number column width to 2 {default 4}
  list = true,                             -- set eol (end of line), tab and tail space in different way
  ...
  guifont = "SauceCodePro Nerd Font Mono:h15",  -- the font used in graphical neovim applications
